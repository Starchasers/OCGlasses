...
public class ModelCubeTESR extends ModelCube {
    ...
    public ModelCubeTESR(ModelBox box){
        this(box.posX1, box.posY1, box.posZ1, box.posX2, box.posY2, box.posZ2);
    }
    ...
    public void drawCube(BufferBuilder buffer){
        drawCube(buffer, p1.x, p1.y, p1.z, p2.x, p2.y, p2.z);
    }
    ...
    protected void drawTop(BufferBuilder buffer, float x1, float y1, float z1, float x2, float y2, float z2){
        buffer.pos(x2, y2, z2).endVertex(); // Bottom Right Of The Quad (Top)
        buffer.pos(x1, y2, z2).endVertex(); // Bottom Left Of The Quad (Top)
        buffer.pos(x1, y2, z1).endVertex(); // Top Left Of The Quad (Top)
        buffer.pos(x2, y2, z1).endVertex(); // Top Right Of The Quad (Top)
    }

    protected void drawBottom(BufferBuilder buffer, float x1, float y1, float z1, float x2, float y2, float z2){
        buffer.pos(x2, y1, z1).endVertex(); // Bottom Right Of The Quad (Bottom)
        buffer.pos(x1, y1, z1).endVertex(); // Bottom Left Of The Quad (Bottom)
        buffer.pos(x1, y1, z2).endVertex(); // Top Left Of The Quad (Bottom)
        buffer.pos(x2, y1, z2).endVertex(); // Top Right Of The Quad (Bottom)
    }

    protected void drawFront(BufferBuilder buffer, float x1, float y1, float z1, float x2, float y2, float z2){
        buffer.pos(x2, y1, z2).endVertex(); // Bottom Right Of The Quad (Front)
        buffer.pos(x1, y1, z2).endVertex(); // Bottom Left Of The Quad (Front)
        buffer.pos(x1, y2, z2).endVertex(); // Top Left Of The Quad (Front)
        buffer.pos(x2, y2, z2).endVertex(); // Top Right Of The Quad (Front)
    }

    protected void drawBack(BufferBuilder buffer, float x1, float y1, float z1, float x2, float y2, float z2){
        buffer.pos(x2, y2, z1).endVertex(); // Bottom Right Of The Quad (Back)
        buffer.pos(x1, y2, z1).endVertex(); // Bottom Left Of The Quad (Back)
        buffer.pos(x1, y1, z1).endVertex(); // Top Left Of The Quad (Back)
        buffer.pos(x2, y1, z1).endVertex(); // Top Right Of The Quad (Back)
    }

    protected void drawLeft(BufferBuilder buffer, float x1, float y1, float z1, float x2, float y2, float z2){
        buffer.pos(x1, y1, z2).endVertex(); // Bottom Right Of The Quad (Left)
        buffer.pos(x1, y1, z1).endVertex(); // Bottom Left Of The Quad (Left)
        buffer.pos(x1, y2, z1).endVertex(); // Top Left Of The Quad (Left)
        buffer.pos(x1, y2, z2).endVertex(); // Top Right Of The Quad (Left)
    }

    protected void drawRight(BufferBuilder buffer, float x1, float y1, float z1, float x2, float y2, float z2){
        buffer.pos(x2, y1, z1).endVertex(); // Bottom Right Of The Quad (Right)
        buffer.pos(x2, y1, z2).endVertex(); // Bottom Left Of The Quad (Right)
        buffer.pos(x2, y2, z2).endVertex(); // Top Left Of The Quad (Right)
        buffer.pos(x2, y2, z1).endVertex(); // Top Right Of The Quad (Right)
    }
