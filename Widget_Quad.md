### 2D Overlay Widget
## Triangle
`widget = component.glasses.addTriangle();`

adds a Triangle to the 2D Overlay
...
* [size methods](Widget_Methods_size)
  * [getSize](Widget_Methods_size#getSize)
  * [setSize](Widget_Methods_size#setSize)
